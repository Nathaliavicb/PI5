...
public class IntegracaoService:IIntegracaoService{
    ...
    public async Task<RetornoAPI> GetDados(string caminho, string nomeAcao){
        ...
        //Montando a URL
        url_padrao = url_padrao + caminho + '/' + nomeAcao + "?range=3mo&interval=1d&fundamental=true&token=" + token;
